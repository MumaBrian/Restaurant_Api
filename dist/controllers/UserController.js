    ...
    static signup(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const emailSent = yield nodeMailer.sendEmail(user.email, `<h1>Your Otp is ${verification_token}</h1>`);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (user) {
                    res.json({ success: true });
                    const nodeMailer = new NodeMailer_1.NodeMailer();
                    const emailSent = yield nodeMailer.sendEmail(user.email, `<h1>Your Otp is ${reset_password_token}</h1>`);
                    console.log(user.email);
                    if (emailSent) {
                        console.log("Email sent successfully");
                    }
