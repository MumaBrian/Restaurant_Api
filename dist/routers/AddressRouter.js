...
class AddressRouter {
    ...
    patchRoutes() {
        this.router.get("/address/:id", GlobalMiddleWare_1.GlobalMiddleWare.auth, GlobalMiddleWare_1.GlobalMiddleWare.checkError, AddressController_1.AddressController.getAddressById);
    }
    putRoutes() {
